...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [[FFGamesCore instance] challengesCount] + [[FFGamesCore instance] autoGeneratedLevelCount];
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *challengeCellIdentifier = @"ChallengeCell";
    static NSString *autogeneratedCellIdentifier = @"AutoGenCell";

    NSUInteger index = (NSUInteger) indexPath.row;

    if (index >= [[FFGamesCore instance] challengesCount]){
        // autogenerated
//        BOOL locked = index >= [FFStorageUtil firstUnsolvedChallengeIndex];

        UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:autogeneratedCellIdentifier];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (index >= [[FFGamesCore instance] challengesCount]){
        // auto-generated challenge!
        FFGame* game = [[FFGamesCore instance] autoGeneratedChallenge:index-[[FFGamesCore instance] challengesCount]];
